function UnityProgress (dom, args) {
	...
	this.Update = function() {
		...
		this.progressFrame.style.left = this.dom.offsetLeft + (this.dom.offsetWidth * 0.5 - logoImg.width * 0.5) + 'px';
		this.progressFrame.width = logoImg.width;
		...
		this.progressBar.width = logoImg.width * Math.min(this.progress, 1);
